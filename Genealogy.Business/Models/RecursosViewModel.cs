...
namespace Genealogy.Business.Models {
	...
	public class RecursosViewModel : BaseModel<RecursosViewModel, Genealogy.Objects.Entities.AppEntitiesContext> {

		///// <summary>
		///// The logger
		///// </summary>
		//private static ILogger<RecursosViewModel> Logger;

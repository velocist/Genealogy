...
namespace velocist.Business.Models.App {
    ...
    /// Contry model
    /// </summary>
    public class CountryModel : BaseModel<CountryModel, Objects.Entities.AppEntitiesContext> {

        /// <summary>
        /// The logger
        /// </summary>
        protected static ILogger<CountryModel> Logger;
        ...
        public IEnumerable<CountryModel> List() {
            try {
                Logger.LogDebug("List<{TEntity},{TContext}>", typeof(CountryModel).Name, typeof(Objects.Entities.AppEntitiesContext).Name);

...
namespace Genealogy.Tests.Services {
    ...
    [TestClass()]
    public class FSRecordServiceTests : ServiceTest<FSRecordModel, FSRecord, FSRecordService> {

        /// <summary>
        /// Initializes a new instance of the <see cref="FSRecordServiceTests"/> class.
        /// </summary>
        public FSRecordServiceTests() : base() {
            _service = new FSRecordService(_unitOfWork);
            _model = GetData.GetFSRecordModel("record_film");
            _list = new() {
                _model,
            };
        ...
        /// </summary>
        [TestMethod()]
        public void ExportTest() => ExportExcel<FSRecordModel>.Export(_list, @"C:\Temp\FSRecordModel.xlsx", true);

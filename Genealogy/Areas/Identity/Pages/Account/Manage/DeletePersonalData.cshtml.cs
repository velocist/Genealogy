...
namespace Genealogy.Areas.Identity.Pages.Account.Manage {
	...
	public class DeletePersonalDataModel : PageModel {
		...
		/// </summary>
		/// <returns></returns>
		/// <exception cref="InvalidOperationException">Unexpected error occurred deleting user with ID '{userId}'.</exception>

...
namespace GenealogyDocumentation {
    /// <summary>
    ...
    [HelpFileBuilderPlugInExport("GenealogyDocumentation", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "GenealogyDocumentation plug-in")]
    public sealed class GenealogyDocumentationPlugIn : IPlugIn {
        ...
        public void Execute(ExecutionContext context) =>
            ...
            builder.ReportProgress("In GenealogyDocumentationPlugIn Execute() method");
        #endregion

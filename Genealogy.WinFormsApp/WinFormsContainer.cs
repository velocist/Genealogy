    ...
    internal static class WinFormsContainer {
        ...
        static WinFormsContainer() {
            try {
                ...
                //builder.RegisterMySqlServer(AccessServiceConfiguration.GetAccessServiceSetting("AppContextConnection"));

                //Register DbContext options services for EntitiesContext
                var connectionString = AccessServiceConfiguration.GetConnectionString(AccessServiceConfiguration.GetAccessServiceSetting("AppContextConnection"));
